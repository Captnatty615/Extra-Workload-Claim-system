        ...
        <div className="default">
          ...
          <div className="sm:col-span-5">
            ...
            <option value="">Choose your department</option>
              ...
              <button type="submit"
              className="rounded-md bg-gray-800 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600">Continue</button>
            </div>
          </form>
        </div>
      </main>
